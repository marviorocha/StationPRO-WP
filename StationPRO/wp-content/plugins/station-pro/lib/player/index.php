              ...
              <div class="col s1 m5 ">
                ...
                <ul>
                  ...
                  <li>
                      ...
                      <li class="right">
<?php if($brand == true){  ?>
                        <a style="font-size:0.800em" target="_blank" title="Station Pro - Plugin Radio" href="https://www.marviorocha.com/stationpro"><i class="fas fa-microphone"></i> by Station Pro</a>
