...
$options[]      = array(
'id'            => 'podcast',
'title'         => 'Publish Episodec',
'post_type'     => 'station_post', // or post or CPT or array( 'page', 'post' )
'context'       => 'normal',
'priority'      => 'default',
'sections'      => array(
...
array(
  ...
  array(
    'id'        => 'podcast_image',
    'type'      => 'image',
    'title'     => 'Get upload thumbnail for audio',
    'add_title' => 'Add thumbnail audio',
  ),
    array(
      'id'            => 'podcast_descricao',
      'type'          => 'textarea',
...
// -----------------------------------------
// Song Metabox Options                    -
// -----------------------------------------

/*

$options[]    = array(
  'id'        => '_custom_post_songs',
  'title'     => 'Add Top Song ',
  'post_type' => 'songs',
  'context'   => 'normal',
  'priority'  => 'default',
   ...
   array(
      ...
      'fields' => array(
        ...
        array(
          ...
          'settings'      => array(
          'upload_type'  => 'mp3',
          'button_title' => 'Get MP3',
          'frame_title'  => 'Select a MP3',
          'insert_title' => 'Insert your MP3 Song',
          ),
