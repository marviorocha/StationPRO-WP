var app = (function () {
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(span, file$1, 17, 6, 634);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button, file$1, 7, 0, 169);
    ...
    const file$2 = "assets/src/components/Nav.svelte";

    function create_fragment$2(ctx) {
    	var div7, div0, t0, nav, div6, div1, img, t1, div2, b, t3, br, t4, div5, t5, span0, t7, button0, t9, div3, input, t10, span1, t11, t12_value = ctx.sound.state(), t12, t13, div4, button1, t15, button2, current;

    	var play = new Play({ $$inline: true });
    	...
    	return {
    		c: function create() {
    			...
    			button0.textContent = "volume_down";
    			t9 = space();
    			div3 = element("div");
    			input = element("input");
    			t10 = space();
    			...
    			button1.textContent = "favorite_border";
    			t15 = space();
    			button2 = element("button");
    			button2.textContent = "share";
    			attr(div0, "id", "app");
    			add_location(div0, file$2, 35, 4, 705);
    			...
    			attr(img, "alt", "");
    			add_location(img, file$2, 42, 10, 988);
    			attr(div1, "class", "p-1 mr-20");
    			add_location(div1, file$2, 41, 8, 954);
    			attr(b, "class", "");
    			add_location(b, file$2, 49, 80, 1266);
    			add_location(br, file$2, 49, 122, 1308);
    			attr(div2, "class", "text-white antialiased text-xs md:text-base md:antialiased");
    			add_location(div2, file$2, 49, 8, 1194);
    			attr(span0, "class", "text-xs font-semibold antialiased text-xs text-white shadow-md bg-red-600 p-1 rounded-md uppercase");
    			add_location(span0, file$2, 56, 10, 1538);
    			attr(button0, "class", "material-icons  text-white");
    			add_location(button0, file$2, 62, 10, 1732);
    			attr(input, "type", "range");
    			attr(input, "class", "rounded-full absolute  opacity-90 overflow-hidden \n            appearance-none transform rotate-90 bottom-14 left-2  cursor-pointer bg-gray-400 h-4 w-24");
    			attr(input, "min", "1");
    			attr(input, "max", "100");
    			attr(input, "step", "1");
    			add_location(input, file$2, 68, 12, 1887);
    			attr(div3, "class", "relative right-20");
    			add_location(div3, file$2, 66, 10, 1840);
    			attr(span1, "class", "leading-8 hidden md:block text-white");
    			add_location(span1, file$2, 74, 10, 2147);
    			attr(button1, "class", "material-icons text-white");
    			add_location(button1, file$2, 76, 12, 2276);
    			attr(button2, "class", "material-icons text-white");
    			add_location(button2, file$2, 77, 12, 2355);
    			attr(div4, "class", "icons-button");
    			add_location(div4, file$2, 75, 10, 2237);
    			attr(div5, "class", "flex justify-center items-center px-1 md:px-24 space-x-3");
    			add_location(div5, file$2, 51, 8, 1338);
    			attr(div6, "class", "relative flex space-x-9 items-center   w-full w-screen  max-w-screen-lg container mx-auto ");
    			add_location(div6, file$2, 39, 8, 832);
    			attr(nav, "id", "app");
    			attr(nav, "class", "bg-blue-500    mt-20 flex items-center bg-opacity-100 h-24");
    			add_location(nav, file$2, 37, 4, 733);
    			attr(div7, "class", "fixed w-full overscroll-y-none overscroll-x-none  bottom-0");
    			attr(div7, "id", "player_stationpro");
    			add_location(div7, file$2, 32, 0, 601);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			append(div6, t4);
    			append(div6, div5);
    			mount_component(play, div5, null);
    			append(div5, t5);
    			append(div5, span0);
    			append(div5, t7);
    			append(div5, button0);
