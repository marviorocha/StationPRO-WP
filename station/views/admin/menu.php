...
<ul id="menu">
  <li><?php echo anchor('admin/dash',lang('dash')); ?> </li>
  <li> <?php echo anchor('admin/pages',lang('pages')); ?> </a>
    <ul>
      <li> <a href="#">CSS</a>
        <ul>
      ...
      <li><?php echo anchor('admin/playlist',lang('playlist')); ?> </a>
        <ul>
  ...
  <li> <a href="#"><?php echo lang('playlist') ?></a>
     <ul>
  ...
  <li> <a href="#"><?php echo lang('plugin') ?></a>
  <li> <a href="#"><?php echo lang('theme') ?></a> </li>
  <li> <a href="#"><?php echo lang('users') ?></a> </li>
  <li> <?php echo anchor('admin/settings',lang('settings')); ?> </li>
</ul>
