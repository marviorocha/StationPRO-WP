var app = (function () {
    ...
    function create_fragment$5(ctx) {
    	var div0, img, t0, div1, b, t1, t2, br, t3;
    	...
    	return {
    		c: function create() {
    			...
    			div1 = element("div");
    			b = element("b");
    			t1 = text(ctx.radio_name);
    			t2 = space();
    			br = element("br");
    			t3 = text(" www.stationpro.com");
    			...
    			attr(img, "alt", "");
    			add_location(img, file$5, 7, 4, 73);
    			attr(div0, "class", "p-1 mr-20");
    			add_location(div0, file$5, 6, 0, 45);
    			attr(b, "class", "text-sm");
    			add_location(b, file$5, 16, 6, 328);
    			add_location(br, file$5, 16, 43, 365);
    			attr(div1, "class", "text-white antialiased  text-xs md:text-base md:antialiased");
    			add_location(div1, file$5, 15, 5, 248);
    		},
    		...
    		p: function update(changed, ctx) {
    			if (changed.radio_name) {
    				set_data(t1, ctx.radio_name);
    			}
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	let { radio_name } = $$props;

    	const writable_props = ['radio_name'];
    	Object.keys($$props).forEach(key => {
    		if (!writable_props.includes(key) && !key.startsWith('$$')) console.warn(`<Metadata> was created with unknown prop '${key}'`);
    	});

    	$$self.$set = $$props => {
    		if ('radio_name' in $$props) $$invalidate('radio_name', radio_name = $$props.radio_name);
    	};
    ...
    class Metadata extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$5, create_fragment$5, safe_not_equal, ["radio_name"]);

    		const { ctx } = this.$$;
    		const props = options.props || {};
    		if (ctx.radio_name === undefined && !('radio_name' in props)) {
    			console.warn("<Metadata> was created without expected prop 'radio_name'");
    		}
    	}
    ...
    // (61:10) <Metadata radio_name={radio_name}>
    ...
    function create_fragment$6(ctx) {
    	...
    	return {
    		...
    		p: function update(changed, ctx) {
    			...
    			if (changed.radio_name) metadata_changes.radio_name = ctx.radio_name;
